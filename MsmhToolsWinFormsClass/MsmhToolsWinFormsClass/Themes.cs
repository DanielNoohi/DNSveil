...
public static class Theme
{
    ...
    public static void LoadTheme(Form form, string theme, bool getParentBackColor = false)
    {
        form.InvokeIt(() =>
        {
            if (theme.Equals(Themes.Light))
            {
                ...
                {
                    SetColors(c, getParentBackColor);
                }
                SetColorsByType(form, getParentBackColor);
            }
    ...
    //=======================================================================================
    private static void SetColorsByType(Form form, bool getParentBackColor = false)
    {
        form.InvokeIt(() =>
        {
            ...
            {
                ccms.BackColor = getParentBackColor && ccms.Parent != null ? ccms.Parent.BackColor : Colors.BackColor;
            ...
            {
                ll.BackColor = getParentBackColor && ll.Parent != null ? ll.Parent.BackColor : Colors.BackColor;
    ...
    //=======================================================================================
    public static void SetColors(Control c, bool getParentBackColor = false)
    {
        c.InvokeIt(() =>
        {
            if (c is TabPage) return;

            c.BackColor = getParentBackColor && c.Parent != null ? c.Parent.BackColor : Colors.BackColor;
            ...
            else if (c is CustomDataGridView customDataGridView)
            {
                ...
                customDataGridView.DefaultCellStyle.BackColor = Colors.BackColor;
                customDataGridView.DefaultCellStyle.ForeColor = Colors.ForeColor;
                customDataGridView.DefaultCellStyle.SelectionBackColor = Colors.Selection;
                customDataGridView.DefaultCellStyle.SelectionForeColor = Colors.ForeColor;
                for (int n = 0; n < customDataGridView.RowCount; n++)
                {
                    DataGridViewRow row = customDataGridView.Rows[n];
                    if (n % 2 == 0)
                        row.DefaultCellStyle.BackColor = Colors.BackColor.ChangeBrightness(-0.2f);
                    else
            ...
            else if (c is CustomLabel customLabel)
            {
                ...
                customLabel.BackColor = getParentBackColor && customLabel.Parent != null ? customLabel.Parent.BackColor : Colors.BackColor;
                customLabel.ForeColor = Colors.ForeColor;
            }
            else if (c is CustomListBox customListBox)
            {
                customListBox.BorderColor = Colors.Border;
                customListBox.SelectionColor = Colors.Selection;
            }
            ...
            {
                customTabControl.BackColor = getParentBackColor && customTabControl.Parent != null ? customTabControl.Parent.BackColor : Colors.BackColor;
            ...
            {
                label.BackColor = getParentBackColor && label.Parent != null ? label.Parent.BackColor : Colors.BackColor;
